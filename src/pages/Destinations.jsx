...
const matchesTag = (d, tagKey) => {
  ...
  if (tagKey === 'visaFriendly') return ['落地签', '电子签', '申根签'].some(v => (d.visaType || '').includes(v))
...
export default function Destinations() {
  ...
  const filtered = useMemo(() => {
    const list = destinations.filter(d => {
      ...
      return matchContinent && matchTag
    })
          ...
          {filtered.map(d => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-slate-500 text-sm mt-1">{d.country} · {d.continent}</p>
