  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 p-4 md:p-5 bg-white rounded-xl shadow-sm border border-slate-100 space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <input
              ...
              autoComplete="off"
              className="flex-1 min-w-[min(100%,12rem)] max-w-xl px-4 py-2.5 rounded-xl border border-slate-200 text-slate-800 focus:outline-none focus:ring-2 focus:ring-amber-400"
            />
            {hasActiveFilters ? (
              <button
                type="button"
                onClick={resetFilters}
                className="shrink-0 px-4 py-2.5 text-sm font-medium text-amber-800 bg-amber-50 border border-amber-200 rounded-xl hover:bg-amber-100 transition"
              >
          ...
          <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-slate-100">
            ...
            <select
              ...
              className="px-3 py-2 min-w-[8rem] max-w-[14rem] rounded-lg border border-slate-200 text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-400"
            >
        ...
        <p className="text-slate-500 text-sm mb-4">{t('articles.resultsCount', { count: filteredArticles.length })}</p>
